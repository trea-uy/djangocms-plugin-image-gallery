...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'image_gallery_carousel', (
        ...
        db.send_create_signal(u'image_gallery', ['Carousel'])

        # Adding model 'CarouselItem'
        db.create_table(u'image_gallery_carouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('carousel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['image_gallery.Carousel'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'image_gallery_carousel')
    ...
    models = {
        ...
        u'image_gallery.carouselitem': {
            ...
            'carousel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['image_gallery.Carousel']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
